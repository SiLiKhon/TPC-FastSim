...
_TENSORID = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='node_name',
            full_name='tensorflow.tf2xla.TensorId.node_name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='output_index',
            full_name='tensorflow.tf2xla.TensorId.output_index',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
_FEED = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='id',
            full_name='tensorflow.tf2xla.Feed.id',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='shape',
            full_name='tensorflow.tf2xla.Feed.shape',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='name',
            full_name='tensorflow.tf2xla.Feed.name',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name='tensorflow.tf2xla.Feed.type',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_FETCH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='id',
            full_name='tensorflow.tf2xla.Fetch.id',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='name',
            full_name='tensorflow.tf2xla.Fetch.name',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='shape',
            full_name='tensorflow.tf2xla.Fetch.shape',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name='tensorflow.tf2xla.Fetch.type',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_VARIABLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='node_name',
            full_name='tensorflow.tf2xla.Variable.node_name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='name',
            full_name='tensorflow.tf2xla.Variable.name',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='shape',
            full_name='tensorflow.tf2xla.Variable.shape',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='type',
            full_name='tensorflow.tf2xla.Variable.type',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='readonly',
            full_name='tensorflow.tf2xla.Variable.readonly',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
...
_CONVERSIONOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='custom_fake_quant_op_calls',
            full_name='tensorflow.tf2xla.ConversionOptions.custom_fake_quant_op_calls',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_CONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='feed',
            full_name='tensorflow.tf2xla.Config.feed',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='fetch',
            full_name='tensorflow.tf2xla.Config.fetch',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='variable',
            full_name='tensorflow.tf2xla.Config.variable',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='tensorflow.tf2xla.Config.conversion_options',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_VARIABLE.fields_by_name[
    'shape'
].message_type = tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
...
TensorId = _reflection.GeneratedProtocolMessageType(
    'TensorId',
    (_message.Message,),
    {
...
Fetch = _reflection.GeneratedProtocolMessageType(
    'Fetch',
    (_message.Message,),
    {
        'DESCRIPTOR': _FETCH,
...
ConversionOptions = _reflection.GeneratedProtocolMessageType(
    'ConversionOptions',
    (_message.Message,),
    {
