...
def get_discriminator(
    ...
    if features_to_tail:
        features_tiled = tf.tile(tf.reshape(features_input, (-1, 1, 1, num_features)), (1, 10, 10, 1))
...
class BaselineModel10x10:
    ...
    def make_fake(self, features):
        ...
        return self.generator(tf.concat([features, latent_input], axis=-1))
